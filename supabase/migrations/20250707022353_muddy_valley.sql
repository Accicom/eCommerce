...
-- Create a new function that uses the webhook approach
...
BEGIN
  ...
  SELECT INTO result net.http_post(
    ...
    headers := jsonb_build_object(
      ...
      'Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRpeHBpeXFpcGp6emNjZGxhcHloIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNzQ5NzUyNywiZXhwIjoyMDUzMDczNTI3fQ.gZwc87RKxw1gcOYOq0ADafH3AvuxJNsKGJVMDvY7pkg'
    ),
    body := payload
  );
